...
public class MergeSorterBubbleStart extends Sorter{
...
//        return arr;
    ...
    public int[] splitter(int[] array) {
        ...
        int numberOfThreads = availableProcessors < 4 ? 4 : availableProcessors;
    ...
    private void treadSort(int numberOfThreads, int[][] spittedArrays) {
        ...
        for (int i = 0; i < numberOfThreads; i++) {
            ...
            threads[i] = new Thread(() -> bSta.sorter(temp));
            threads[i].start();
        }
